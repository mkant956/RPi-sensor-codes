...
GPIO.setup(23, GPIO.OUT)# set GPIO 24 as output for red led

white = GPIO.PWM(18, 100)    # create object white for PWM on port 25 at 100 Hertz
red = GPIO.PWM(23, 100)      # create object red for PWM on port 24 at 100 Hertz
